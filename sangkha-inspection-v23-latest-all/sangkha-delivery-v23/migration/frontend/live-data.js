...
(function () {
  ...
  var user = {};
  try { user = JSON.parse(rawUser); } catch (_) { user = {}; }
  ...
  function syncLegacyCards(data) {
    var completed = data && data.completed != null ? data.completed : 0;
    var pending = data && data.pending != null ? data.pending : 0;
    var committee = data && data.committee != null ? data.committee : 0;
    var average = data && data.average != null ? data.average : 0;
    var mappings = { statCompleted: completed, statPending: pending, statCommittee: committee, statAverage: formatAverage(average) };
